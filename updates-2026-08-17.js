...
(() => {
  ...
  function featureLatest(){
    ...
    document.getElementById('today-updates')?.remove();
    document.getElementById('today-saradi')?.remove();
    ...
    s20.innerHTML=`<div class="container"><div class="today-updates-head"><span class="latest-highlight-badge">20 ಆಗಸ್ಟ್ 2026 · Latest Newspaper Coverage</span><h2>20 ಆಗಸ್ಟ್ 2026 — ಆರು ಪ್ರಮುಖ ಪತ್ರಿಕಾ ವರದಿಗಳು</h2><p>ಪ್ರತಿ ಪತ್ರಿಕಾ ವರದಿಯನ್ನು ಪ್ರತ್ಯೇಕವಾಗಿ ವೀಕ್ಷಿಸಿ · View all six newspaper cuttings separately</p></div><div class="today-updates-grid">${NEWS20.map((img,i)=>card(img,`20 ಆಗಸ್ಟ್ 2026 · ಪತ್ರಿಕಾ ವರದಿ ${i+1} · Newspaper cutting ${i+1}`)).join('')}</div></div>`;
  ...
  function installUnifiedImageViewer(){
    if(!document.getElementById('unified-image-viewer-style')){
      ...
      style.textContent=`
        .site-image-lightbox{width:min(1040px,calc(100vw - 32px))!important;max-width:1040px!important;height:min(92dvh,900px)!important;max-height:92dvh!important;padding:0!important;border:0!important;border-radius:20px!important;overflow:hidden!important;background:#171113!important;color:#fff!important;box-shadow:0 32px 100px rgba(20,8,12,.48)!important}
        .site-image-lightbox::backdrop{background:rgba(24,10,14,.80)!important;backdrop-filter:blur(8px) saturate(.9)!important}
        .site-lightbox-shell{position:relative!important;width:100%!important;height:100%!important;min-height:0!important;display:flex!important;align-items:stretch!important;justify-content:center!important}
        .site-lightbox-figure{width:100%!important;height:100%!important;margin:0!important;padding:0 58px 14px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:center!important}
        .site-lightbox-stage{width:100%!important;min-height:0!important;flex:1 1 auto!important;display:flex!important;justify-content:center!important;align-items:center!important;padding:22px 0 8px!important;overflow:hidden!important;background:transparent!important}
        .site-lightbox-image{display:block!important;width:auto!important;height:auto!important;max-width:100%!important;max-height:calc(92dvh - 86px)!important;object-fit:contain!important;margin:auto!important;border-radius:5px!important;box-shadow:0 12px 38px rgba(0,0,0,.30)!important}
        .site-lightbox-caption{flex:0 0 auto!important;max-width:900px!important;padding:6px 12px 2px!important;color:rgba(255,255,255,.78)!important;text-align:center!important;font:600 .78rem/1.45 "Noto Sans Kannada",Inter,sans-serif!important}
        .site-lightbox-close,.modal-close{border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;color:#fff!important;text-shadow:0 1px 5px rgba(0,0,0,.72)!important}
        .site-lightbox-close{position:absolute!important;top:10px!important;right:12px!important;z-index:100!important;width:36px!important;height:36px!important;padding:0!important;display:grid!important;place-items:center!important;font:300 2.1rem/1 Inter,Arial,sans-serif!important}
        .site-lightbox-close:hover,.site-lightbox-close:active,.modal-close:hover,.modal-close:active{background:transparent!important;color:#fff!important;transform:scale(1.08)!important}
        main img{cursor:zoom-in}
        @media(max-width:700px){.site-image-lightbox{width:calc(100vw - 8px)!important;height:97dvh!important;max-height:97dvh!important;border-radius:15px!important}.site-lightbox-figure{padding:0 38px 10px!important}.site-lightbox-stage{padding:48px 0 5px!important}.site-lightbox-image{max-height:calc(97dvh - 94px)!important}.site-lightbox-close{top:7px!important;right:8px!important;width:34px!important;height:34px!important;font-size:2rem!important}.site-lightbox-caption{padding:5px 4px 0!important;font-size:.72rem!important}}
      `;
